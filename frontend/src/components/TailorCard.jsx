export default function TailorCard({ name, location, specialty, rating = 4.8, tags = ['Wedding', 'Alterations'] }) {
  return (
    <article className="group overflow-hidden rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-lg">
      ...
      <div className="mt-6 flex items-center gap-3">
        <button className="button-primary text-sm">View profile</button>
